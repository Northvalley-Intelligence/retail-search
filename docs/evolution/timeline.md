...
| `SE-0002` | `M-0001` | Phase 1 | Cranfield | `ARCH-0.2-candidate` | not assigned | `A-0002` | `ADL-0002` | PRF rerank plus phrase coherence is best current Cranfield candidate; cached tuning loop and paper-BM25 comparison recorded; transferability pending |
| `SE-0003` | `M-0001` | Phase 1 | Cranfield | `ARCH-0.3-candidate` | not assigned | `A-0002` | `ADL-0003` | BGE vector/hybrid beats refined PRF offline and in remote OpenSearch; transferability and promotion policy pending |
| `SE-0004` | `M-0001` | Phase 1 | Cranfield | `ARCH-0.4-candidate` | not assigned | `A-0002` | `ADL-0004` | BGE-feature LTR beats refined PRF offline; compare against simpler BGE hybrid before promotion |
